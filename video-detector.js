/* ============================================================
   VIDEO DETECTOR v3.0 — AI Probability Analyzer
...
(function buildDOM() {
    ...
    <div class="vd-container">
      <div class="vd-header">
        <span class="vd-badge">// AI Probability Analyzer v3</span>
        ...
        <div class="vd-result" id="vdResult">
          ...
          <div class="vd-details">
            ...
            <div class="vd-disclaimer">
              ...
              <p>Probabilistic analysis v3.0 — 4 layers: inter-frame pixel coherence (25%), local temporal consistency (20%), audio forensics voice (20%), LLaVA+LLaMA vision pipeline (35%). This system evaluates a <strong>probability</strong>, never absolute certainty. Natural compression artifacts may generate false positives. Always cross-reference with other sources for a definitive verdict.</p>
            </div>
          </div>
        </div>
...
async function startVideoAnalysis() {
    ...
    try {
        ...
        console.group('[VideoDetector] 📊 AI Probability Report v3.0');
...
console.log('✅ VideoDetector v3.0 ready — AI Probability Analyzer (probabilistic, never binary)');
